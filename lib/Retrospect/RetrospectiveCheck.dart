...
class RetrospectiveCheck extends StatefulWidget {
  @override
  _RetrospectiveCheckState createState() => _RetrospectiveCheckState();
}

class _RetrospectiveCheckState extends State<RetrospectiveCheck>
      ...
      return Scaffold(
        ...
        body: Stack(
          children: [
            ...
            if (canRetrospect == false && dropdownList.isNotEmpty)
              Align(
